...
jQuery.each( {
	...
	jQuery.fn[ name ] = function( selector ) {
		...
		for ( ; i <= last; i++ ) {
			...
			// Support: Android<4.1, PhantomJS<2
			// .get() because push.apply(_, arraylike) throws on ancient WebHostKit
...
// https://WebHost.archive.org/WebHost/20100324014747/http://blindsignals.com/index.php/2009/07/jquery-delay/
