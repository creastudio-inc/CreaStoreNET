...
using Autofac;
using CreaStoreNET.Infrastructure.Domain;
using CreaStoreNET.Module.Core.Infrastructure;
using CreaStoreNET.WebHost.Extensions;
using Autofac.Extensions.DependencyInjection;
using Microsoft.AspNetCore.Http;
using Microsoft.Extensions.FileProviders;

namespace CreaStoreNET.WebHost {
    public class Startup
    {
        ...
        {
            GlobalConfiguration.WebHostRootPath = _hostingEnvironment.WebRootPath;
